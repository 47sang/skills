...
```bash
python3 /Users/zhou/.hermes/skills/openclaw-imports/annual-report/scripts/list_reports.py <股票代码> [关键词] [年份]
```
...
```bash
python3 /Users/zhou/.hermes/skills/openclaw-imports/annual-report/scripts/download_report.py <股票代码> <报告类型> [年份] [保存目录]
```
